<template>
	<view>
		<!-- <view class="tg-nav01">
      <image class="tg-img01" :src="hhdata.teamImgUrl"></image>
    </view> -->
		<view class="tg-nav01">
	...
	export default {
		...
		methods: {
			dataFun: function() {
				...
				api.apiPost('/user/teamext?type=lead', '', '', 'get', (status, res, code) => {
					if (res.code == 0) {
...
<style>
	...
	/* .tg-nav02{ position: absolute; z-index: 2; bottom: 0; left: 0; background: #FFFFFF; width: 650upx; padding: 0 50upx; height: 240upx; display: flex;} */
	.tg-a {
		width: 96upx;
		height: 96upx;
		margin-top: 72upx;
