<template>
	<view class="content">
		...
		<view class="apply-row">
			...
			<view class="apply-iptbox"><input class="apply-ipt" v-model="sfz" type="text" placeholder="请输入身份证号" maxlength="18" placeholder-style="color:#CFCFCF" /></view>
		</view>
		<view class="apply-row">
			<text class="apply-t">手机号</text>
			<view class="apply-iptbox"><input class="apply-ipt" v-model="mobile" type="text" placeholder="请输入手机号" placeholder-style="color:#CFCFCF" /></view>
		</view>
		<view class="apply-row">
			<text class="apply-t">验证码</text>
			<view class="apply-iptbox"><input class="apply-ipt" v-model="msgCode" type="text" placeholder="请输入手机验证码" placeholder-style="color:#CFCFCF" maxlength="4" /><text
	...
	export default {
		...
		methods: {
			...
			historynext: function(id) {
				uni.navigateTo({
					url: "/pages/index/cardhistoryapply/cardhistoryapply?id=" + id + "&key=" + this.key
				})
			},
		}
	}
...
<style>
	...
	.applytitle{ font-size: 36upx; font-weight: bold; color: #000000; margin-bottom: 60upx;}
	.apply-row {
		margin-bottom: 50upx;
		display: flex;
	}
